...
class BVec2Property : public VectorProperty<bvec2> {
  ...
  Q_PROPERTY(bool x READ (_get<0>) WRITE (_set<0>) DESIGNABLE true STORED false FINAL)
  Q_PROPERTY(bool y READ (_get<1>) WRITE (_set<1>) DESIGNABLE true STORED false FINAL)
