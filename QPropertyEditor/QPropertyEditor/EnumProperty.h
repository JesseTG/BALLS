...
/**
  ...
  QPropertyEditor.
  Enum Properties are automatically created in the QPropertyModel for objects
  that
...
public:
  ...
  virtual QWidget* createEditor(
    QWidget* parent, const QStyleOptionViewItem& option) noexcept override;
  /** @see Property::setEditorData */
  virtual bool
    setEditorData(QWidget* editor, const QVariant& data) noexcept override;
